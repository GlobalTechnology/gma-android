...
public class Contract {
    ...
    public static final class LegacyTables {
        ...
        public static final String SQL_DELETE_MEASUREMENTS_TABLE = "DROP TABLE IF EXISTS measurements";
        public static final String SQL_DELETE_MEASUREMENTS_DETAILS_TABLE = "DROP TABLE IF EXISTS measurement_details";
        public static final String SQL_DELETE_MEASUREMENTS_BREAKDOWN_TABLE = "DROP TABLE IF EXISTS breakdown_data";
        public static final String SQL_DELETE_MEASUREMENTS_SIX_MONTHS_TABLE = "DROP TABLE IF EXISTS six_month_amounts";
        public static final String SQL_DELETE_MEASUREMENTS_SUB_MINISTRIES_TABLE =
                "DROP TABLE IF EXISTS sub_ministry_details";
        public static final String SQL_DELETE_MEASUREMENTS_TEAM_MEMBERS_TABLE =
                "DROP TABLE IF EXISTS team_member_details";
        public static final String SQL_DELETE_MEASUREMENTS_TYPE_IDS_TABLE = "DROP TABLE IF EXISTS measurement_type_ids";
    }
