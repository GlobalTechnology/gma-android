...
public class Contract {
    ...
    public static final class Measurement extends Base implements MinistryId {
        ...
        static final String[] PROJECTION_ALL =
                {COLUMN_MEASUREMENT_ID, COLUMN_MINISTRY_ID, COLUMN_MCC, COLUMN_PERIOD, COLUMN_LAST_SYNCED};
        ...
        public static final String SQL_CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (" +
                TextUtils.join(",", new Object[] {SQL_COLUMN_ROWID, SQL_COLUMN_MEASUREMENT_ID, SQL_COLUMN_MINISTRY_ID,
                        SQL_COLUMN_MCC, SQL_COLUMN_PERIOD, SQL_COLUMN_LAST_SYNCED}) + ");";
        public static final String SQL_DELETE_TABLE = "DROP TABLE IF EXISTS " + TABLE_NAME;
