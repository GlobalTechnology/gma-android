...
import static com.expidev.gcmapp.Constants.EXTRA_TYPE;
...
import com.expidev.gcmapp.support.v4.content.AssignmentLoader;
...
public class MeasurementsActivity extends ActionBarActivity {
    ...
    private void loadMeasurementColumnsFragmentIfNeeded() {
        ...
        final ColumnsListFragment fragment = ColumnsListFragment.newInstance(mType, mGuid, mMinistryId, mMcc, mPeriod);
